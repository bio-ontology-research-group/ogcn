...
@ck.command()
@ck.option(
    '--train-data-file', '-trdf', default='data/data_human.pkl',
...
def main(train_data_file, test_data_file, terms_file, out_file, root_class, fold):
    ...
    # test_data_file = f'fold{fold}_exp-' + test_data_file
    ...
    annotations = train_df['prop_phenotypes'].values
    annotations = list(map(lambda x: set(x), annotations))
    test_annotations = test_df['prop_phenotypes'].values
